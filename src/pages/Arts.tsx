...
export const ARTS_DATA: ArtForm[] = [
  ...
  {
    name: "Roghan Painting",
    state: "Gujarat",
    history: "A 400-year-old art form from the Kutch region, traditionally practiced by the Khatri community.",
    description: "Vibrant art created by painting on fabric using a thick paste made from castor oil and natural colors.",
    materials: ["Castor oil", "Natural pigments", "Cotton fabric", "Stylus"],
    significance: "A rare craft kept alive by a few families, known for its intricate geometric and floral patterns."
  },
  {
    name: "Kalamkari",
    state: "Andhra Pradesh",
    history: "Ancient style of hand-painting on cotton textile, flourishing under the patronage of Golconda Sultanate and Mughals.",
    description: "Intricate narratives from epics like Ramayana and Mahabharata depicted using natural dyes and kalam (pen).",
    materials: ["Cotton cloth", "Bamboo pen", "Vegetable dyes", "Myrobalan", "Buffalo milk"],
    significance: "Preserves ancient storytelling traditions through visual art on textiles."
  },
  {
    name: "Gond Art",
    state: "Madhya Pradesh",
    history: "Practiced by the Gond tribe, one of the largest tribal communities in India, to decorate their mud walls.",
    description: "Characterized by a sense of movement, using dots and lines to create vibrant images of flora, fauna, and gods.",
    materials: ["Charcoal", "Colored soil", "Plant sap", "Mud", "Cow dung"],
    significance: "Believed to bring good luck and ward off evil, reflecting the tribe's deep connection with nature."
  },
  {
    name: "Kathakali Masks",
    state: "Kerala",
    history: "Integral to Kathakali dance-drama which originated in the 17th century.",
    description: "Elaborate, colorful face make-up and headgear that transform actors into mythological characters.",
    materials: ["Rice paste", "Lime", "Natural colors", "Wood (for headgear)", "Paper maché"],
    significance: "Crucial for conveying the 'Navarasas' (nine emotions) and defining character archetypes in the performance."
  },
  {
    name: "Channapatna Toys",
    state: "Karnataka",
    history: "Dates back to the reign of Tipu Sultan in the 18th century, who invited Persian artisans to train locals.",
    description: "Colorful, smooth, and safe wooden toys made from soft ivory wood and coated with natural lacquer.",
    materials: ["Ivory wood (Aale mara)", "Natural lacquer", "Vegetable dyes"],
    significance: "Recognized with a GI tag, these eco-friendly toys are a symbol of traditional Indian toy-making craftsmanship."
  },
  {
    name: "Dokra Art",
    state: "West Bengal / Chhattisgarh",
    history: "An ancient non-ferrous metal casting technique using the lost-wax process, dating back to the Indus Valley Civilization.",
    description: "Rustic and primitive look featuring folk motifs, animals, and human figures made from brass or bronze.",
    materials: ["Brass", "Bronze", "Beeswax", "Clay", "Resin"],
    significance: "One of the oldest known metal casting techniques still in continuous use, preserving prehistoric metallurgical knowledge."
  }
];
