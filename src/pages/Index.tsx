...
import FeaturedDestination from "@/features/FeaturedDestination";
import Hero from "@/components/layout/Hero";
import TripPlanner from "@/features/TripPlanner";
import DailyFeaturedDestination from "@/features/DailyFeaturedDestination";
import TravelTips from "@/features/TravelTips";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="container mx-auto px-4 py-16 space-y-24">
        {/* Daily Featured Destination */}
        <DailyFeaturedDestination />
        ...
        <section className="space-y-12 relative">
          <div className="absolute -top-10 -left-10 opacity-10 hidden lg:block">
            <Sparkles className="w-32 h-32 text-secondary animate-pulse" />
          </div>

          <div className="text-center space-y-4">
            <span className="px-4 py-1 bg-secondary text-secondary-foreground rounded-full text-sm font-medium inline-block">
              Powered by AI
            </span>
            <h2 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-secondary via-accent to-primary">
