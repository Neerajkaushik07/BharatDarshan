...
import { TouristPlace, UserPlace, Festival } from "@/types/states";
...
const StateDialog = ({ isOpen, onClose, stateName, places, festivals = [] }: StateDialogProps) => {
      ...
      <DialogContent className="max-w-4xl h-[80vh] flex flex-col p-0 gap-0 overflow-hidden bg-white">
        <div className="relative h-[35vh] bg-cover bg-center transition-all duration-500"
          ...
          <DialogHeader className="relative z-10 h-full p-6 flex flex-col justify-between">
            ...
            <div className="flex flex-col items-end gap-2 text-white/90">
        ...
        >
          <div className="border-b px-6 pt-4">
            <TabsList className="w-full max-w-2xl grid grid-cols-4">
              ...
              <TabsTrigger value="festivals" className="text-base">
                Festivals
          ...
          <div className="flex-1 overflow-auto">
            ...
            <TabsContent value="reviews" className="p-6 h-full">
              <PlaceReviews placeId={getPlaceId(currentPlace, stateName)} />
            </TabsContent>
            ...
            <TabsContent value="festivals" className="p-6 h-full">
              {festivals && festivals.length > 0 ? (
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <h3 className="text-2xl font-bold text-primary">Famous Festivals of {stateName}</h3>
                    <Badge variant="secondary" className="px-3 py-1 text-sm font-medium">
                ...
                <div className="flex items-center justify-center h-full">
                  <div className="text-center">
                    <Sparkles className="w-20 h-20 mx-auto text-primary/20" />
                    <h3 className="mt-6 text-xl font-semibold text-primary">No festival information available</h3>
                    <p className="mt-2 text-sm text-muted-foreground">
                      We are currently updating our database with festival information for {stateName}.
                    </p>
                  </div>
                </div>
              )}
